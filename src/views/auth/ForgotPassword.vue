      ...
      <div class="flex flex-col justify-center items-center h-full relative">
        <div class="max-form w-full lg:py-0 py-10">
          ...
          <div class="bg-white rounded-[0.432rem] lg:p-0 p-4">
            <h1 class="font-['poppins'] font-bold text-[26px] text-center">Forgot Password ?</h1>
            <p class="font-poppins font-normal text-[14px] mt-2 lg:text-[#838282] text-[#4E8D6E] text-center">
        ...
        <!-- form footer -->
        <div class="max-form w-full absolute bottom-5 justify-between items-center lg:flex hidden">
          <div class="flex ">
